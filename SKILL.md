...
1. Inspect every uploaded source; request missing photos rather than substituting old assets. Resolve settings from the user's request and defaults. Retain an original-to-output mapping in the job folder.
